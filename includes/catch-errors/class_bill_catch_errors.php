...
function cardealer_bill_hooking_catch_errors()
{
        if (function_exists('is_admin') && function_exists('current_user_can')) {
            if(is_admin() and current_user_can("manage_options")){
                ...
                $cardealer_plugin_slug = 'restore-classic-widgets';
...
add_action("wp_ajax_bill_minozzi_js_error_catched", "cardealer_BillCatchErrors\\bill_minozzi_js_error_catched");
add_action("wp_ajax_nopriv_bill_minozzi_js_error_catched", "cardealer_BillCatchErrors\\bill_minozzi_js_error_catched");
    ...
    if (isset($_REQUEST)) {
        ...
        foreach ($errors as $error) {
            ...
            if($log_error) {
                ...
                if($cardealer_plugin_slug  == 'wptools')
