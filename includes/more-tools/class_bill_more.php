<?php // namespace cardealer_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
add_action("init", "cardealer_bill_more");
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class cardealer_Bill_Minozzi_Add_Ajax_Url
{
...
$cardealer_bill_minozzi_add_ajax_url = new cardealer_Bill_Minozzi_Add_Ajax_Url();
class cardealer_Bill_show_more_plugins
{
    //
    public function __construct()
    {
        ...
        // add_action('wp_ajax_bill_install_plugin2', array('\cardealer_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
        ...
        // work add_action('wp_ajax_bill_install_plugin2', '\cardealer_BillMore\bill_install_plugin2');
    }
...
$show_more_plugins = new cardealer_Bill_show_more_plugins();
// } // end namespace
class cardealer_PluginInstaller
{
    public function __construct()
    {
    ...
    public function bill_install_plugin2()
    {
        ...
        $plugin = $slug;
        $skin = new \cardealer_bill_install_QuietSkin(["api" => $api]);
...
$plugin_installer = new cardealer_PluginInstaller();
//$plugin_installer->install_plugin();
require_once ABSPATH . "wp-admin/includes/plugin-install.php";
require_once ABSPATH . "wp-admin/includes/class-wp-upgrader.php";
class cardealer_bill_install_QuietSkin extends \WP_Upgrader_Skin
{
    public function __construct()
    {
        parent::__construct();
...
$quiet_skin = new cardealer_bill_install_QuietSkin();
