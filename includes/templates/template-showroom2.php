    ...
    while ($wp_query->have_posts()):
       ...
       // $output .= ($hp <> '' ? $hp . ' ' . __('HP', 'cardealer') . '<br />' : '');
        ...
        if ($miles_label == 'Miles') {
            $output .= __('Miles', 'cardealer') . '<br />';
        } elseif ($miles_label == 'Hours') {
            $output .= __('Hours', 'cardealer') . '<br />';
        } elseif ($miles_label == 'Kms') {
            $output .= __('Kms', 'cardealer') . '<br />';
        }
...
wp_reset_query();
if ($qposts < 1) {
    $output .= '<br /><h4>' . esc_attr__('Not Found !', 'cardealer') . '</h4>';
}
...
echo wp_kses($output, $cardealer_my_allowed);
