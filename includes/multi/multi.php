...
function cardealer_load()
{
    ...
    */
        ...
        wp_enqueue_script(
            'cardealer_edit_fields',
            CARDEALERURL . 'includes/multi/multi.js',
            array('jquery'),
            CARDEALERVERSION
        );
        ...
        wp_enqueue_style(
            'pluginStyleGeneral6',
            CARDEALERURL . 'includes/multi/multi.css',
            array(),
            CARDEALERVERSION
        );
...
if (!isset($_POST["cardealersecurity"]) || !wp_verify_nonce(sanitize_text_field($_POST["cardealersecurity"]), 'cardealer_cfield')) {
    wp_die('fail');
}
    ...
    if (function_exists('wp_json_encode')) 
      wp_die(wp_json_encode($field_value));
    else
