...
esc_attr($CarDealer_recipientEmail); ?>" />
  <input type="hidden" name="cardealer_the_title" id="cardealer_the_title" value="<?php echo esc_attr($cardealer_the_title); ?>" />
  <h2><?php 
  echo esc_attr__('Request Information', 'cardealer'); 
  ?>...</h2>
  <ul>
    <li>
      <label for="CarDealer_senderName" class="CarDealer_contact" ><?php echo esc_attr__('Your Name',
'cardealer'); ?>:&nbsp;</label>
      <input type="text" name="CarDealer_senderName" id="CarDealer_senderName" placeholder="<?php echo
esc_attr__('Please type your name', 'cardealer'); ?>" required="required" maxlength="40" />
    </li>
    <li>
      <label for="CarDealer_senderEmail" class="CarDealer_contact"><?php echo esc_attr__('Your Email',
'cardealer'); ?>:&nbsp;</label>
      <input type="email" name="CarDealer_senderEmail" id="CarDealer_senderEmail" placeholder="<?php echo
esc_attr__('Please type your email', 'cardealer'); ?>" required="required" maxlength="50" />
    </li>
    <li>
      <label for="CarDealer_sendermessage" class="CarDealer_contact" style="padding-top: .5em;"><?php echo
esc_attr__('Your Message', 'cardealer'); ?>:&nbsp;</label>
      <textarea name="CarDealer_sendermessage" id="CarDealer_sendermessage" placeholder="<?php echo
esc_attr__('Please type your message', 'cardealer'); ?>" required="required"  maxlength="10000"></textarea>
    </li>
  </ul>
<br />
  <div id="formButtons">
    <input type="submit" id="CarDealer_sendMessage" name="sendMessage" value="<?php echo
esc_attr__('Send', 'cardealer'); ?>" />
    <input type="button" id="CarDealer_cancel" name="cancel" value="<?php echo esc_attr__('Cancel',
'cardealer'); ?>" />
  </div>
