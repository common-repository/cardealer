<?php namespace cardealer_BillInstall;
//
/**
 * @ Author: Bill Minozzi
...
use cardealer_BillDiagnose\MemoryChecker;
use cardealer_BillDiagnose\ErrorChecker;
// ------------------------- Ago 24 -------------------- 

  if (!class_exists('cardealer_BillDiagnose\MemoryChecker')) {
      return;
  }
...
/////////////// Class Begin //////////////////
class cardealer_Bill_Class_Plugins_Install
{
    ...
    public function pre_checkup_page_content()
    {
        ...
        switch ($step) { case 1: ?> 
                <div class="bill_install_wrap">
                    ...
                    $diagnose_instance = new cardealer_Bill_Class_Plugins_Install(
...
$plugin_install = new cardealer_Bill_Class_Plugins_Install(
    $plugin_slug,
    $notification_url,
    $notification_url2,
    $plugin_text_domain,
